...
class ContractTab extends StatefulWidget {
  final String leadId;
  const ContractTab({super.key, required this.leadId});
...
class _ContractTabState extends State<ContractTab> {
    ...
    return GestureDetector(
      onTap: () async {
        ...
        if (result != null && result.files.isNotEmpty) {
          ...
          context.read<FileUploadContractCubit>().selectFile(selectedFile);
        }
      },
      child: Container(
        height: 200,
  ...
  Widget _buildFileItem(String name, String type, String time, String filePath,int contractId) {
    return Padding(
